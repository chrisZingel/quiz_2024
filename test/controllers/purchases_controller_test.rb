...
class PurchasesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create purchase" do
    assert_difference("Purchase.count") do
      post purchases_url, params: { purchase: { amount: @purchase.amount, tracking_id: @purchase.tracking_id } }
    end
  ...
  test "should update purchase" do
    patch purchase_url(@purchase), params: { purchase: { amount: @purchase.amount, tracking_id: @purchase.tracking_id } }
